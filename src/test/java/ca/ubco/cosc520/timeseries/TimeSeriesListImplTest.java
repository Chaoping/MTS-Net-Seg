...
public class TimeSeriesListImplTest {
  ...
  public void testTruncate() {
    ...
    assertThat(truncated.getByIndex(0),
        is(Arrays.copyOfRange(timeSeriesList.getByIndex(0), 10, 21)));
    assertThat(truncated.getByIndex(1),
        is(Arrays.copyOfRange(timeSeriesList.getByIndex(1), 10, 21)));
  }
